...
def translate_now():
    ...
    try:
        ...
        messagebox.showerror("googletrans", "Vui lòng thử lại")
...
#translate button
translate = Button(root, text = "Translate", font = "Roboto 15 bold italic", activebackground = "yellow", cursor = "hand2", bd = 5, bg = "skyblue", fg = "black", command = translate_now)
